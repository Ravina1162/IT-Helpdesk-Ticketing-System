...
function WorkflowList() {
  ...
  const fetchWorkflows = () => {
    axios.get('http://localhost:5000/getWorkflows', { withCredentials: true })
      .then(response => {
  ...
  const handleCreateWorkflow = () => {
    axios.post('http://localhost:5000/workflows', newWorkflow , { withCredentials: true })
      .then(() => {
  ...
  const handleDeleteWorkflow = (issuesid) => {
    axios.delete(`http://localhost:5000/workflows/${issuesid}` , { withCredentials: true })
      .then(() => {
